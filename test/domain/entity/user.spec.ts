  ...
  describe('Test validations', () => {
    describe('Name validations', () => {
      test('Should throw an error if name is not a string', () => {
        ...
        expect(() => new User(numberName, email, password, role, phoneNumber)).toThrow(
      ...
      test('Should return an error if name is missing', () => {
        ...
        expect(() => new User(noName, email, password, role, phoneNumber)).toThrow(
      ...
      test('Should return an error if name\'s length < 3', () => {
        ...
        expect(() => new User(badName, email, password, role, phoneNumber)).toThrow(
    ...
    describe('Email validations', () => {
      test('Should return an error if email is not a string', () => {
        ...
        expect(() => new User(name, numberEmail, password, role, phoneNumber)).toThrow(
      ...
      test('Should return an error if no email', () => {
        ...
        expect(() => new User(name, noEmail, password, role, phoneNumber)).toThrow(
      ...
      test('Should return an error if invalid email', () => {
        ...
        expect(() => new User(name, invalidEmail, password, role, phoneNumber)).toThrow(
          Error('Invalid email')
        )
      });
    })
    ...
    describe('Role validations', () => {
      test('Should return an error if no role', () => {
        ...
        expect(() => new User(name, email, password, noRole, phoneNumber)).toThrow(
      ...
      test('Should return an error if role is not a string', () => {
        ...
        expect(() => new User(name, email, password, numberRole, phoneNumber)).toThrow(
          Error('Role should be a string')
        )
      });
      ...
      test('Should return an error if invalid role', () => {
        ...
        expect(() => new User(name, email, password, invalidRole, phoneNumber)).toThrow(
          Error('Invalid role')
        )
      });
    })
    ...
    describe('PhoneNumber Validations', () => {
      test('Should return an error if invalid phone number', () => {
        ...
        expect(() => new User(name, email, password, role, invalidPhoneNumber)).toThrow(
      ...
      test('Should throw an error if phone nombre is not a string', () => {
        ...
        expect(() => new User(name, email, password, role, number)).toThrow(
